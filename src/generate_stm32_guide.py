# src/generate_stm32_guide.py
import os

def generate_deployment_guide():
    """Generate step-by-step STM32 deployment guide"""
...
"""
    ...
    with open('docs/STM32_Deployment_Guide.md', 'w', encoding='utf-8') as f:
        f.write(guide_content)
    
    print("📝 STM32 deployment guide created: docs/STM32_Deployment_Guide.md")
